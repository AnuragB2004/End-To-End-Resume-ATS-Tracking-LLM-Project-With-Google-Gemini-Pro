...
## Video Demo
https://github.com/user-attachments/assets/368d38b3-2e0b-475b-b6e6-1b41c677c613
...
```bash
git clone https://github.com/AnuragB2004/End-To-End-Resume-ATS-Tracking-LLM-Project-With-Google-Gemini-Pro/
```
...
Maintainer: Anurag Bhattacharjee
